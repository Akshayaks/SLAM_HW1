...
#         # ipdb.set_trace()
#         delta_rot1 = np.arctan2(u_t1[0,1] - u_t0[0,1], u_t1[0,0] - u_t0[0,0]) - u_t0[0,2]
#         delta_trans = np.sqrt((u_t1[0,1] - u_t0[0,1])**2 + (u_t1[0,0] - u_t0[0,0])**2)
#         delta_rot2 = u_t1[0,2] - u_t0[0,2] - delta_rot1
